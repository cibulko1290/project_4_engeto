...
Metodology of tasks:
1.	The table uses data of average salaries from all the sectors between 2006 and 2018. The data have been selected by the clause **Having**, in which the decrease is shown. The result is focused on the salary decrease. Otherwise the increase of salaries is assumed.
