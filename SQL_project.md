...
Metodology of tasks:
1.	The table uses data of average salaries from all the sectors between 2006 and 2018. According to the clause **Having** has been selected data, in which the decrease appeared. The resul is concentrated on the occurrence of decreasing of salary.
