...
2.	In this task, a calculation has been made of the number of loaves of bread and litres of milk as the total quantity of both items combined. The used data were specified for bread and milk only. In the calculation, the units of bread and milk were verified. First, the average salary in the given year was calculated for all sectors. Subsequently, the average price of bread and milk was calculated as a sum of both. This intermediate step was not necessary. In any case, in the paid versions of database, it is possible to perform the calculation of the average salary divided by the average price of both items. Database Postgres needs to further specify the final calculation from the basic data. See the script task_2.sql
...
2.	In terms of purchasing power, the number of units of bread and milk that could be purchased increased from 679 in 2006 to 738 in 2018.
