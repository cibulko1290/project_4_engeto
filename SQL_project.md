...
Metodology of tasks:
1.	The table uses data of average salaries from all the sectors between 2006 and 2018. According to the clause **Having** has been selected data, in which the decrease appeared. The result is concentrated on the occurrence of decreasing of salary. Otherwise the increasing of salaries is assumed.
...
4.	Over the observed period, the average annual increase in prices across all commodities did not exceed 10% in any year. The annual increase reached almost 10% in 2007 (9.26% to be exact).
